...
class SMACrossover(Strategy):
    """
    Classic SMA crossover: go long when the fast SMA crosses above
    the slow SMA, exit when it crosses below.

    Parameters
    ----------
    fast_period : int
        Window for the fast (short-term) moving average. Default 10.
    slow_period : int
        Window for the slow (long-term) moving average. Default 30.
    """
